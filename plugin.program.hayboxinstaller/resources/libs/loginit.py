...
ORDER          = ['sportsaccess', 'communityportal', 'tvportal', 'flawless', 'sportsmania', 'sportsnationhdtv', 'ultimatemania', 'dexter', 'reboot', 'ivue', 'ontapptv', 'vpnicity', 'overlordtv', 'xtreamcodes']
...
LOGINID = { 
	...
	'flawless': {
		...
		'settings' : os.path.join(ADDONS, 'plugin.video.FlawlessTv', 'settings.xml'),
		'default'  : 'Username',
